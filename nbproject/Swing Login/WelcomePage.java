...
public class WelcomePage {
    ...
    public WelcomePage() {
        ...
        JLabel greetingLabel = new JLabel("<html>Welcome! You have successfully logged in. Click <a href='file:///C:/Users/rathe/Downloads/Fibrenet%20Billing/Fibrenet%20Billing/Clone.html'>here</a> to Choose Your Fibrenet Booking.</html>");
        ...
        greetingLabel.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    Desktop.getDesktop().browse(new URI("file:///C:/Users/rathe/Downloads/Fibrenet%20Billing/Fibrenet%20Billing/Clone.html"));
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
            }
